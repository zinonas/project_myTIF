    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Fieldset(
                ...
                'assessment_of_iron_load_serrum_one',
                'assessment_of_iron_load_serrum_one_date',
                'assessment_of_iron_load_serrum_two',
                'assessment_of_iron_load_serrum_two_date',
                'assessment_of_iron_load_serrum_three',
                'assessment_of_iron_load_serrum_three_date',
                'assessment_of_iron_load_liver_mri',
                'assessment_of_iron_load_liver_mri_date',
                'assessment_of_iron_load_fibroscan',
                'assessment_of_iron_load_fibroscan_date',
                'assessment_of_iron_load_intra_hepatic_iron',
                'assessment_of_iron_load_method_mri',
                'assessment_of_iron_load_method_cardiac_iron ',
                'assessment_of_iron_load_ti_bassal_hb_rate',
                'assessment_of_iron_load_ti_bassal_per_hbf',
                'serolocigal_data_HCV',
                'serolocigal_data_HCV_PCR',
                'serolocigal_data_HBV',
                'serolocigal_data_HIV',
                'current_treatment_transfusion_regime',
                'current_treatment_chelation',
                'current_treatment_chelation_start',
                'current_treatment_chelation_drug',
                'current_treatment_bone_marrow',
                'current_treatment_bone_marrow_date',
                'current_treatment_bone_marrow_success',
                'current_treatment_replacement_ther',
                'current_treatment_sex_horm',
                'current_treatment_insulin',
                'current_treatment_thyroid',
                'current_treatment_hepatitis_treatment_c',
                'current_treatment_hepatitis_treatment_b',
                'current_treatment_by_hydroxyurea',
                'current_treatment_by_hydroxyurea_with_epo',
