...
class Diagnosis(models.Model):
    ...
    age_of_diagnosis = models.DecimalField(null=True,blank=True)
    age_at_onset_of_symptoms = models.DecimalField(null=True,blank=True)
...
class Clinical_data(models.Model):
    ...
    age_of_first_transfusion = models.DecimalField(null=True,blank=True)
    yesno_option = (
        ('','Please select'),
        ('Yes','Yes'),
        ('No','No')
...
class Clinical_data_two(models.Model):
    ...
    prophylactic_measures_antibiotic_prophylaxis_penicillin_age = models.DecimalField(null=True,blank=True)
    ...
    prophylactic_measures_vaccinations_pneumococcal_OCV_age = models.DecimalField(null=True,blank=True)
    ...
    monitoring_tests_annual_liver_profile_age = models.DecimalField(null=True,blank=True)
    ...
    monitoring_tests_annual_renal_profile_blood_urea_age = models.DecimalField(null=True,blank=True)
    ...
    monitoring_tests_annual_renal_profile_creatine_age = models.DecimalField(null=True,blank=True)
    ...
    monitoring_tests_annual_renal_profile_proteiuria_age = models.DecimalField(null=True,blank=True)
    ...
    monitoring_tests_annual_calcium_metabolism_serum_calcium_age = models.DecimalField(null=True,blank=True)
    ...
    monitoring_tests_annual_parvovirus_serology_age = models.DecimalField(null=True,blank=True)
    ...
    monitoring_tests_annual_pulmonary_function_age = models.DecimalField(null=True,blank=True)
    ...
    monitoring_tests_annual_hip_radiology_age = models.DecimalField(null=True,blank=True)
    ...
    onitoring_tests_annual_ophthalmic_evaluation_age = models.DecimalField(null=True,blank=True)
    complications_dactylitis = models.DecimalField('Age', null=True, blank=True)
    ...
    complications_splenic_sequestration = models.DecimalField('Age', null=True, blank=True)
    complications_splenic_sequestration_date = models.DateField('Date',null=True,blank=True)
    complications_aplastic_crisis = models.DecimalField('Age', null=True, blank=True)
    complications_aplastic_crisis_date = models.DateField('Date',null=True,blank=True)
    complications_acute_chest_syndrome = models.DecimalField('Age', null=True, blank=True)
    complications_acute_chest_syndrome_date = models.DateField('Date',null=True,blank=True)
    complications_multi_organ_failure_syndrome = models.DecimalField('Age', null=True, blank=True)
    complications_multi_organ_failure_syndrome_date = models.DateField('Date',null=True,blank=True)
    complications_priapism = models.DecimalField('Age', null=True, blank=True)
    complications_priapism_date = models.DateField('Date',null=True,blank=True)
    complications_heart_failure = models.DecimalField('Age',null=True, blank=True)
    complications_heart_failure_date = models.DateField('Date',null=True,blank=True)
    complications_pulmonary_hypertension = models.DecimalField('Age', null=True, blank=True)
    complications_pulmonary_hypertension_date = models.DateField('Date',null=True,blank=True)
    complications_allo_immunation = models.DecimalField('Age', null=True, blank=True)
    complications_allo_immunation_date = models.DateField('Date',null=True,blank=True)
    complications_iron_overload = models.DecimalField('Age',null=True, blank=True)
    complications_iron_overload_date = models.DateField('Date',null=True,blank=True)
    complications_serious_infection = models.DecimalField('Age', null=True, blank=True)
    complications_serious_infection_date = models.DateField('Date',null=True,blank=True)
    complications_azoospermia = models.DecimalField('Age', null=True, blank=True)
