...
class Clinical_data(models.Model):
    ...
    clinical_data_cholelithiasis = models.CharField('Cholelithiasis', max_length=3,choices=clinical_data_option, default=clinical_data_option[0][0])
    clinical_data_cholelithiasis_date = models.DateField('Date measured',null=True,blank=True)
    clinical_data_cholecystectomy = models.CharField('Cholecystectomy', max_length=3,choices=clinical_data_option, default=clinical_data_option[0][0])
    clinical_data_cholecystectomy_date = models.DateField('Date measured',null=True,blank=True)
    clinical_data_splenectomy = models.CharField('Splenectomy', max_length=3,choices=clinical_data_option, default=clinical_data_option[0][0])
    clinical_data_splenectomy_date = models.DateField('Date measured',null=True,blank=True)
    clinical_data_iron_overload_heart = models.CharField('Iron overload heart', max_length=3,choices=clinical_data_option, default=clinical_data_option[0][0])
    clinical_data_iron_overload_heart_date = models.DateField('Date measured',null=True,blank=True)
    clinical_data_heart_failure = models.CharField('Heart failure', max_length=3,choices=clinical_data_option, default=clinical_data_option[0][0])
    clinical_data_heart_failure_date = models.DateField('Date measured',null=True,blank=True)
    clinical_data_cardiac_arrythmia = models.CharField('And/or cardiac arrythmia', max_length=3,choices=clinical_data_option, default=clinical_data_option[0][0])
    clinical_data_cardiac_arrythmia_date = models.DateField('Date measured',null=True,blank=True)
    clinical_data_glucose_intolerance = models.CharField('Glucose intolerance', max_length=3,choices=clinical_data_option, default=clinical_data_option[0][0])
    clinical_data_glucose_intolerance_date = models.DateField('Date measured',null=True,blank=True)
    clinical_data_diabetes = models.CharField('Diabetes', max_length=3,choices=clinical_data_option, default=clinical_data_option[0][0])
    clinical_data_diabetes_date = models.DateField('Date measured',null=True,blank=True)
    clinical_data_hypothyroidism = models.CharField('Hypothyroidism', max_length=3,choices=clinical_data_option, default=clinical_data_option[0][0])
    clinical_data_hypothyroidism_date = models.DateField('Date measured',null=True,blank=True)
    clinical_data_hypoparathyroidism = models.CharField('Hypoparathyroidism', max_length=3,choices=clinical_data_option, default=clinical_data_option[0][0])
    clinical_data_hypoparathyroidism_date = models.DateField('Date measured',null=True,blank=True)
    clinical_data_hypogonadism = models.CharField('Hypogonadism', max_length=3,choices=clinical_data_option, default=clinical_data_option[0][0])
    clinical_data_hypogonadism_date = models.DateField('Date measured',null=True,blank=True)
    clinical_data_iron_overload_liver = models.CharField('Iron overload liver', max_length=3,choices=clinical_data_option, default=clinical_data_option[0][0])
    clinical_data_iron_overload_liver_date = models.DateField('Date measured',null=True,blank=True)
    clinical_data_others = models.CharField('Others (Thromboembolism, cancers,...)', max_length=3,choices=clinical_data_option, default=clinical_data_option[0][0])
    clinical_data_others_date = models.DateField('Date measured',null=True,blank=True)
    #clinical_data_pregnancy_id = models.ForeignKey(Pregnancy)
...
class A_b_sickle_thal (models.Model):
    ...
    hb = models.IntegerField('Hb',max_length=3, null=True, blank=True)
    mcv = models.IntegerField('MCV',max_length=3, null=True, blank=True)
    mch = models.IntegerField('MCH',max_length=3, null=True, blank=True)
    ...
    cell_acetate_electr  = models.CharField('Option',max_length=3, choices =thal_option,null=True, blank=True)
    cell_acetate_electr_comment = models.CharField('Comment',max_length=25, null=True, blank=True)
    acid_agarose_citrate  = models.CharField('Option',max_length=3, choices =thal_option,null=True, blank=True)
    acid_agarose_citrate_comment= models.CharField('Comment',max_length=25, null=True, blank=True)
    isoelect_foc  = models.CharField('Option', max_length=3, choices =thal_option,null=True, blank=True)
    isoelect_foc_comment= models.CharField('Comment',max_length=25, null=True, blank=True)
    hlpc_cap_elect = models.CharField('Option',max_length=3, choices =thal_option,null=True, blank=True)
    hlpc_cap_elect_comment= models.CharField('Comment',max_length=25, null=True, blank=True)

    quant_hba2  = models.IntegerField('HbA<sub>2</sub>', max_length=3, null=True, blank=True)
    quant_hbh  = models.IntegerField('HbH',max_length=3, null=True, blank=True)
    ...
    conf_pres_hbs  = models.CharField('Confirm the presence of an HbS by sickling test or a solubility test',max_length=3,choices=plus_minus_option, default=plus_minus_option[0][0])
    conf_pres_hbe  = models.CharField('Confirm the presence of an HbE by the DCIP test',max_length=3,choices=plus_minus_option, default=plus_minus_option[0][0])
    ...
    conf_pres_un_haemo_heat_option = models.CharField('Heat test', max_length=3, null=True, blank=True,choices=plus_minus_option, default=plus_minus_option[0][0])
...
class Redcell_enzyme_dis (models.Model):
    ...
    hk_option = models.CharField('Hexokinase (HK)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    hk = models.CharField(max_length=45, null=True, blank=True)
    gpi_option = models.CharField('Glucosephosphate isomerase (GPI)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    gpi = models.CharField(max_length=45, null=True, blank=True)
    pfk_option = models.CharField('Phosphofructokinase (PFK)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    pfk = models.CharField(max_length=45, null=True, blank=True)
    g3ph_option = models.CharField('Glyceraldehyde-3-phosphate dehydrogenase',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    g3ph = models.CharField(max_length=45, null=True, blank=True)
    pgk_option = models.CharField('Phosphoglycerate kinase (PGK)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    pgk = models.CharField(max_length=45, null=True, blank=True)
    pk_option = models.CharField('Pyruvate kinase (PK)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    pk_v = models.CharField(max_length=45, null=True, blank=True)
    tpi_option = models.CharField('Triosephorate isomerase (TPI)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    tpi = models.CharField(max_length=45, null=True, blank=True)
    ldh_option = models.CharField('Lactate dehydrogenase (LDH)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    ldh = models.CharField(max_length=45, null=True, blank=True)
    adolase_option = models.CharField('Adolase',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    adolase = models.CharField('Adolase comment',max_length=45, null=True, blank=True)
    enolase_option = models.CharField('Enolase',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    enolase = models.CharField('Enolase comment',max_length=45, null=True, blank=True)
    bpgm_option = models.CharField('Biphosphoglycerate mutase (BPGM)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    bpgm = models.CharField(max_length=45, null=True, blank=True)
    mpgm_option = models.CharField('Monophosphoglycerate mutase (MPGM)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    mpgm = models.CharField(max_length=45, null=True, blank=True)
    pgm_option = models.CharField('Phosphocluconate mutase (PGM)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    ...
    cerumen_option = models.CharField('Cerumen',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    cerumen = models.CharField(max_length=45, null=True, blank=True)
    g6pd_option = models.CharField('Glucose-6-phosphate dehydrogenase (G6PD)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    g6pd = models.CharField(max_length=45, null=True, blank=True)
    no6pgd_option = models.CharField('6-phosphogluconate dehydrogenase (6-PGD)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    no6pgd = models.CharField(max_length=45, null=True, blank=True)
    gcs_option = models.CharField('Gamma-glutamylcysteine synthetase (GCS)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    gcs = models.CharField(max_length=45, null=True, blank=True)
    gshs_option = models.CharField('Glutathione synthetase (GSH-S)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    gshs = models.CharField(max_length=45, null=True, blank=True)
    gr_option = models.CharField('Glutathione reductase (GR)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    gr = models.CharField(max_length=45, null=True, blank=True)
    gshpx_option = models.CharField('Glutathione peroxidase (GSH-Px)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    gshpx = models.CharField(max_length=45, null=True, blank=True)
    gst_option = models.CharField('Glutathione s-transferase (GST)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    ...
    ak_option = models.CharField('Adenylate kinase (AK)',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    ak = models.CharField(max_length=45, null=True, blank=True)
    pyr5nuc_option = models.CharField('Pyrimidine-5'' nucleotidase',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    pyr5nuc = models.CharField(max_length=45, null=True, blank=True)
    pur_pyr_ratio_option = models.CharField('Purine/pyrimidine nucleotides ratio',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    ...
    nadh_dia_option = models.CharField('NADH diaphorase',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    nadh_dia = models.CharField(max_length=45, null=True, blank=True)
    nadph_dia_option = models.CharField('NADPH diaphorase',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    nadph_dia_act = models.CharField(max_length=45, null=True, blank=True)
    sod_option = models.CharField('Superoxide dismutase',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    sod_act = models.CharField(max_length=45, null=True, blank=True)
    catalase_option = models.CharField('Catalase', max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
    catalase = models.CharField(max_length=45, null=True, blank=True)
    other_option = models.CharField('Other',max_length=13, null=True, blank=True, choices=plus_minus_option, default=plus_minus_option[0][0])
...
class Cong_dyseryth_anaemia(models.Model):
    patient =  models.ForeignKey(Demographic)
    complt_blood_cnt = models.IntegerField('Complete blood count',max_length=5, null=True, blank=True)
    abs_reticulo_cnt = models.IntegerField('Absolute reticulocyte count',max_length=5, null=True, blank=True)
    soluble_transf_recept = models.IntegerField('Soluble transferring receptor',max_length=5, null=True, blank=True)
    bone_marrow_recept = models.IntegerField('Bone marrow receptor',max_length=5, null=True, blank=True)
    plus_minus_option = (
        ('','Please select'),
        ('Done','Done'),
        ('Not done','Not done')
    ...
    moleculare_analysis = models.CharField('Option',max_length=5, null=True, blank=True,choices=plus_minus_option, default=plus_minus_option[0][0])
